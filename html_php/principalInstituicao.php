...
<html>
	<head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/principalInstituicao.css"> 
        <script type = "text/javascript" src = "../js/principalInstituicao.js"></script>
    ...
    <body>
        ...
        <div id = "principal">
            <form id = "pesquisa" method = "GET" action = "principalInstituicao.php">
            ...
            <div class = "anuncios">
                <div class = "listagem">
                    ...
                    while($registro = $resultado->fetch_object())
                    {
                        ...
                        {
                            echo "<a href = 'anuncioPessoalInstituicao.php?codigoAnuncio=" . $registro->codigoAnuncio . "'><div id = 'anuncioPerda'>";
                        ...
                        {
                            echo "<a href = 'anuncioInstitucionalInstituicao.php?codigoAnuncio=" . $registro->codigoAnuncio . "'><div id = 'anuncioPerda'>";
                            echo "<div id = 'pnlImagem' class = 'imagemAnuncio'>";
                            if(!empty($registro->urlImagem))
                            {
                                echo "<img onload = 'adaptarImagem(this)' id = 'imagemAnuncio' src = '" . $registro->urlImagem . "'>";
