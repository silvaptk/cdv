...
<html>
    <head>
        ...
        <script rel = "text/javascript" src = "../js/modificarAnuncioPessoa.js"></script>
    ...
    <body>
        <div id = "principal">  
            ...
            <form enctype="multipart/form-data" id = "formularioCadastro" method = "POST" action = "modificarAnunPessoa.php?codigoAnuncio=<?php echo $_GET['codigoAnuncio'] ?>">
                ...
                <input type = "button" name="Enviar" value = "Enviar" id = "botao" onclick="enviar();"> <input type = "button" id = "voltar" onclick = "window.location.href = 'perfilPessoa.php'" value = "Voltar"> 
            </form> 
        ...
        <?php
        $sql = "CALL sp_obter_anuncio_pessoal(" . $_GET['codigoAnuncio'] . ");";
